...
window.SPELLS_IT = {
  ...
  "Find Familiar": {
    name: "Trova Famiglio",
    description: "Ottieni il servizio di un famiglio, uno spirito che prende la forma animale che scegli tra: pipistrello, gatto, granchio, rana (rospo), falco, lucertola, polipo, gufo, serpente velenoso (innocuo), pesce (luccio), ratto, corvo, cavalluccio marino, ragno o donnola. Il famiglio appare in uno spazio non occupato entro la gittata e ha le statistiche della forma scelta, sebbene non sia un animale ordinario: è un celestiale, un folletto o un immondo (decidi tu al momento dell'evocazione). Il famiglio agisce di propria iniziativa, separato dalla tua, ma esegue sempre gli ordini che gli impartisci. In combattimento decide le proprie azioni; non può compiere l'azione di Attacco, ma può svolgere altre azioni come di consueto. Se cala a 0 punti ferita, il famiglio svanisce senza lasciare resti fisici e ricompare quando ripeti l'incantesimo. Mentre il famiglio si trova entro 30 metri da te, puoi comunicare con esso telepaticamente. Inoltre, con un'azione, puoi vedere attraverso i suoi occhi e udire attraverso le sue orecchie fino all'inizio del tuo turno successivo, ottenendo i benefici dei sensi speciali eventualmente posseduti dalla creatura; durante questo tempo sei privo della vista e dell'udito riguardo ai tuoi sensi. Con un'azione puoi congedare temporaneamente il famiglio in una tasca dimensionale, dove rimane finché non lo richiami con un'altra azione (riappare in qualsiasi spazio non occupato entro 9 metri da te); puoi inoltre congedarlo in modo permanente. Puoi avere un solo famiglio alla volta: lanciando l'incantesimo mentre ne hai già uno fai assumere al famiglio una nuova forma scelta dall'elenco. Infine, finché il famiglio si trova entro 30 metri da te, puoi lanciare attraverso di esso un incantesimo a contatto come se l'avessi lanciato tu stesso, usando la sua reazione e la sua posizione come punto di origine; il famiglio deve trovarsi nelle condizioni di poter raggiungere il bersaglio.",
    higherLevels: null,
  ...
  "Find Steed": {
    ...
    description: "Evochi uno spirito che assume la forma di un destriero straordinariamente intelligente, forte e leale, creando un legame duraturo con esso. Il destriero appare in uno spazio non occupato entro la gittata, con la forma a tua scelta tra cavallo da guerra, pony, cammello, alce o mastino (il DM può consentire altre cavalcature di taglia opportuna). La creatura ha le statistiche della forma scelta, ma è un celestiale, un folletto o un immondo (decidi tu al momento dell'evocazione). Se la cavalcatura aveva Intelligenza 5 o inferiore, la sua Intelligenza diventa 6 e ottiene la capacità di comprendere una lingua a tua scelta tra quelle che parli. La cavalcatura ti serve come compagna affidabile e funge da unità coesa con te quando la cavalchi: in particolare, mentre sei in groppa, qualunque incantesimo che bersaglia solo te può influenzare anche la cavalcatura. Quando la creatura scende a 0 punti ferita, svanisce senza lasciare resti fisici. Puoi inoltre congedarla in qualsiasi momento con un'azione, facendola scomparire; rilanciando l'incantesimo richiami lo stesso spirito (in forma identica o diversa, a tua scelta) con i suoi punti ferita massimi. Mentre la cavalcatura si trova entro 1,5 km da te, puoi comunicare con essa telepaticamente. Puoi avere una sola cavalcatura legata da questo incantesimo alla volta.",
    higherLevels: null
  },
  "Find Traps": {
  ...
  "Modify Memory": {
    ...
    description: "L'incantatore tenta di alterare i ricordi di una creatura entro gittata che riesce a vedere. Il bersaglio effettua un TS Saggezza, con vantaggio se è in combattimento contro l'incantatore. In caso di fallimento è ammaliato per la durata: incapacitato e ignaro di quanto avviene attorno a sé, ma in grado di udire l'incantatore. Se subisce danni o è bersaglio di un altro incantesimo, l'effetto termina e nessun ricordo viene alterato.\n\nMentre l'ammaliamento è attivo, l'incantatore può modificare il ricordo che il bersaglio conserva di un evento avvenuto nelle ultime 24 ore, della durata massima di 10 minuti. Le opzioni sono: cancellare il ricordo dell'evento, fissarlo nella mente con perfetta lucidità in ogni dettaglio, alterare singoli dettagli, oppure costruire il ricordo di un evento del tutto diverso.\n\nPer applicare la modifica l'incantatore deve descriverla a voce, e il bersaglio deve comprendere il linguaggio usato. La mente del bersaglio riempie eventuali lacune nella descrizione. Se l'incantesimo termina prima che la descrizione sia completa, i ricordi originali restano intatti; se invece la descrizione è portata a termine, i nuovi ricordi si fissano nella mente al termine dell'incantesimo.\n\nUn ricordo modificato non sempre influenza il comportamento del bersaglio, soprattutto se contraddice le sue inclinazioni naturali, il suo allineamento o le sue convinzioni. Un ricordo palesemente illogico (per esempio, l'amore per i bagni nell'acido) viene ignorato e probabilmente liquidato come un brutto sogno; il DM può decidere che un ricordo troppo insensato non abbia alcun effetto rilevante.\n\nRimuovi maledizione o ristorare superiore lanciati sul bersaglio ripristinano i ricordi reali.",
    higherLevels: "Lanciato con uno slot di 6° livello: l'evento può risalire fino a 7 giorni prima. Slot di 7° livello: 30 giorni. Slot di 8° livello: 1 anno. Slot di 9° livello: qualsiasi momento del passato del bersaglio."
  },
  "Passwall": {
    name: "Passapareti",
  ...
  "Guards and Wards": {
    ...
    description: "Crei una serie di protezioni magiche che pervadono un edificio o una porzione di esso. Puoi proteggere un'area in piano alta fino a 6 metri equivalente a un quadrato di 60 metri di lato, oppure puoi suddividere la protezione in cento quadrati di 3 metri di lato o venticinque quadrati di 6 metri di lato (a tua scelta). L'area protetta può avere qualunque forma, e può estendersi su più piani purché tu possa percorrere a piedi un percorso ininterrotto fra le porzioni che la compongono. Quando lanci l'incantesimo, puoi designare individui specifici esenti dai suoi effetti e una parola d'ordine che, una volta pronunciata, rende esente chiunque la conosca. L'intera area irradia magia. Lancia dispel magic su uno specifico effetto annulla solo quel singolo effetto. Le seguenti protezioni sono in vigore per la durata dell'incantesimo: i corridoi vengono riempiti di nebbia che li rende fortemente oscurati, e a ogni intersezione o biforcazione c'è il 50% di probabilità che una creatura non esente sia indotta a credere di proseguire dritta mentre in realtà gira (il DM determina la nuova direzione); tutte le porte dell'area sono chiuse magicamente, come per chiusura arcana, e fino a dieci porte a tua scelta sono celate da un muro illusorio che le mostra come pareti continue, ma su cui le creature possono passare attraverso in entrambi i sensi; tutte le scale dell'area sono riempite con un effetto di ragnatele come l'incantesimo ragnatela: le ragnatele bruciate o spazzate via si riformano dopo 10 minuti finché l'incantesimo persiste. In aggiunta, scegli uno dei seguenti effetti aggiuntivi da collocare nell'area: quattro luci danzanti, posizionate dove desideri, possono essere programmate con un semplice schema di movimento; due bocche magiche poste in luoghi a tua scelta; due nubi maleodoranti in punti a tua scelta, che si riformano dopo 10 minuti se dispersi finché l'incantesimo persiste; un costante vento sostenuto in un singolo corridoio o stanza; una suggestione che agisce come un'aura mentale in un quadrato di 1,5 metri, ripetendo a chiunque vi entri un consiglio mentale di una decina di parole. Se lanci questo incantesimo ogni giorno per un anno consecutivo sulla stessa zona, le protezioni diventano permanenti.",
    higherLevels: null,
  ...
  "Prismatic Spray": {
    ...
    description: "Otto raggi di luce multicolore si sprigionano dalla mano dell'incantatore. Ogni raggio è di colore differente e produce un effetto distinto. Ogni creatura entro un cono di 18 metri deve effettuare un TS Destrezza. Per ciascun bersaglio si tira un d8 per determinare quale raggio lo colpisce.\n\n1. Rosso. TS fallito: 10d6 danni da fuoco; con un successo, metà.\n\n2. Arancione. TS fallito: 10d6 danni acidi; con un successo, metà.\n\n3. Giallo. TS fallito: 10d6 danni da fulmine; con un successo, metà.\n\n4. Verde. TS fallito: 10d6 danni da veleno; con un successo, metà.\n\n5. Blu. TS fallito: 10d6 danni da freddo; con un successo, metà.\n\n6. Indaco. TS fallito: il bersaglio è trattenuto. Alla fine di ogni proprio turno effettua un TS Costituzione: tre successi pongono fine all'incantesimo per quel bersaglio; tre fallimenti lo trasformano permanentemente in pietra (condizione pietrificato). I successi e i fallimenti non devono essere consecutivi: si conteggiano fino al raggiungimento di tre dello stesso tipo.\n\n7. Viola. TS fallito: il bersaglio è accecato. All'inizio del turno successivo dell'incantatore deve effettuare un TS Saggezza: con successo non è più accecato; con fallimento viene trasportato su un altro piano d'esistenza scelto dal DM (di norma, una creatura su un piano diverso da quello d'origine viene esiliata sul piano d'origine; le altre vengono inviate sul Piano Astrale o sul Piano Etereo) e non è più accecato.\n\n8. Speciale. Il bersaglio è colpito da due raggi. Si tira altre due volte sulla tabella, ignorando ulteriori risultati di 8.",
    higherLevels: null
  },
  "Project Image": {
  ...
  "Teleport": {
    name: "Teletrasporto",
    description: "L'incantesimo trasporta istantaneamente l'incantatore e fino a otto creature consenzienti a sua scelta, situate entro gittata e che egli sia in grado di vedere, oppure un singolo oggetto entro gittata, in una destinazione a sua scelta. Se viene bersagliato un oggetto, esso deve essere interamente contenuto in un cubo con spigolo di 3 m e non deve essere impugnato o trasportato da una creatura non consenziente.\n\nLa destinazione deve essere conosciuta dall'incantatore e situata sul suo stesso piano d'esistenza. La familiarità con la destinazione determina la precisione dell'arrivo: il DM tira un d100 e consulta la tabella sotto.\n\nFamiliarità (Errore / Area Simile / Fuori Bersaglio / Sul Bersaglio):\n• Cerchio permanente: — / — / — / 01-100\n• Oggetto associato: — / — / — / 01-100\n• Molto familiare: 01-05 / 06-13 / 14-24 / 25-100\n• Visto per caso: 01-33 / 34-43 / 44-53 / 54-100\n• Visto una volta: 01-43 / 44-53 / 54-73 / 74-100\n• Descrizione: 01-43 / 44-53 / 54-73 / 74-100\n• Falsa destinazione: 01-50 / 51-100 / — / —\n\nDefinizioni di familiarità.\nCerchio permanente: l'incantatore conosce la sequenza di simboli di un cerchio di teletrasporto permanente.\nOggetto associato: l'incantatore possiede un oggetto prelevato dalla destinazione da non più di sei mesi (per esempio un libro dalla biblioteca di un mago, un tessuto da una camera reale, una scheggia di una tomba di lich).\nMolto familiare: un luogo che l'incantatore ha visitato spesso, ha studiato attentamente, o riesce a vedere al momento del lancio.\nVisto per caso: un luogo visto più di una volta ma non frequentato.\nVisto una volta: un luogo visto una sola volta, anche tramite magia.\nDescrizione: un luogo di cui l'incantatore conosce ubicazione e aspetto solo per descrizione altrui o tramite una mappa.\nFalsa destinazione: un luogo che non esiste — magari l'incantatore ha visto un'illusione del rifugio nemico, o tenta di teletrasportarsi in un sito ormai distrutto.\n\nRisultati.\nSul Bersaglio. L'incantatore e i suoi compagni (o l'oggetto) appaiono nel punto desiderato.\n\nFuori Bersaglio. Appaiono a distanza casuale dal bersaglio in direzione casuale: la distanza fuori bersaglio è (1d10 × 1d10)% della distanza che si voleva percorrere. La direzione è determinata da un d8 (1 = nord, 2 = nord-est, 3 = est, e così via in senso orario).\n\nArea Simile. Appaiono in un'area diversa, ma visivamente o tematicamente affine alla destinazione (per esempio, un altro laboratorio alchemico al posto del proprio). Di norma è l'area simile più vicina, ma in teoria può trovarsi in qualunque punto del piano.\n\nErrore. La magia instabile rende il viaggio difficoltoso. Ogni creatura teletrasportata (o l'oggetto) subisce 3d10 danni da forza, e il DM ripete il tiro sulla tabella per stabilire dove finiscono. Errori multipli applicano i danni ogni volta.",
    higherLevels: null
  },
  ...
  "Earthquake": {
    name: "Terremoto",
    description: "L'incantatore provoca una violenta scossa sismica in un punto del terreno entro gittata che riesce a vedere. Per la durata, il suolo trema entro un raggio di 30 m dal punto scelto, coinvolgendo le creature e le strutture a contatto con il terreno nell'area.\n\nIl terreno nell'area diventa terreno difficile. Una creatura sul terreno che si stia concentrando deve superare un TS Costituzione, altrimenti la sua concentrazione viene interrotta.\n\nAl lancio e alla fine di ogni proprio turno mentre l'incantatore mantiene la concentrazione, ogni creatura sul terreno nell'area effettua un TS Destrezza: con un fallimento cade prona. A discrezione del DM possono manifestarsi ulteriori effetti dovuti al tipo di terreno, fra cui:\n\nCrepe. A partire dall'inizio del turno successivo a quello del lancio, nell'area si aprono 1d6 crepe in punti decisi dal DM. Ogni crepa è larga 3 m, profonda 1d10 × 3 m e si estende da un bordo all'altro dell'area. Una creatura nel punto in cui si apre una crepa effettua un TS Destrezza: con un fallimento vi precipita dentro; con un successo riesce a portarsi sul bordo. Una struttura sopra una crepa che si apre crolla automaticamente.\n\nStrutture. La scossa infligge 50 danni contundenti a ogni struttura a contatto con il terreno nell'area, sia al lancio sia all'inizio di ogni turno dell'incantatore fino al termine. Una struttura ridotta a 0 PF crolla, e ogni creatura entro una distanza pari a metà della sua altezza effettua un TS Destrezza: con un fallimento subisce 5d6 danni contundenti, cade prona ed è seppellita dai detriti (per liberarsi serve un'azione e una prova di Forza, Atletica, contro CD 20 — modificabile dal DM in base alla natura dei detriti); con un successo subisce metà danni, non cade prona e non viene seppellita.",
    higherLevels: null,
  ...
  "Prismatic Wall": {
    ...
    description: "Un piano di luce iridescente forma un muro opaco verticale di dimensioni fino a 27 metri di lunghezza, 9 metri di altezza e 2,5 cm di spessore, centrato su un punto entro gittata che l'incantatore riesce a vedere. In alternativa, l'incantatore può modellare il muro in una sfera del diametro massimo di 9 metri centrata sul punto scelto. Il muro permane per la durata. Se il posizionamento attraversa lo spazio occupato da una creatura, l'incantesimo fallisce e sia l'azione sia lo slot incantesimo vengono sprecati.\n\nIl muro emana luce intensa entro 9 metri e luce fioca per altri 9 metri. L'incantatore e le creature da lui designate al lancio possono attraversare il muro o sostarvi vicino senza subire danni. Una creatura in grado di vedere il muro che giunge entro 6 metri o vi inizia il proprio turno deve superare un TS Costituzione, altrimenti è accecata per 1 minuto.\n\nIl muro è composto da sette strati, ciascuno di colore differente. Quando una creatura tenta di protendersi oltre il muro o di attraversarlo, lo fa uno strato alla volta finché non li ha superati tutti. Per ogni strato attraversato o toccato deve effettuare un TS Destrezza: in caso di fallimento subisce gli effetti dello strato.\n\nIl muro può anche essere distrutto, sempre uno strato alla volta procedendo dal rosso al viola, ciascuno con un metodo specifico. Uno strato distrutto resta tale per la durata. Un campo anti-magia non ha effetto; dissolvi magie agisce solo sullo strato viola.\n\n1. Rosso. TS fallito: 10d6 danni da fuoco (metà con successo). Mentre lo strato è attivo, gli attacchi a distanza non magici non possono attraversare il muro. Distrutto da almeno 25 danni da freddo.\n\n2. Arancione. TS fallito: 10d6 danni acidi (metà con successo). Mentre lo strato è attivo, gli attacchi a distanza magici non possono attraversare il muro. Distrutto da un vento forte.\n\n3. Giallo. TS fallito: 10d6 danni da fulmine (metà con successo). Distrutto da almeno 60 danni da forza.\n\n4. Verde. TS fallito: 10d6 danni da veleno (metà con successo). Distrutto da passapareti o da un altro incantesimo di livello pari o superiore in grado di aprire un varco in superfici solide.\n\n5. Blu. TS fallito: 10d6 danni da freddo (metà con successo). Distrutto da almeno 25 danni da fuoco.\n\n6. Indaco. TS fallito: la creatura è trattenuta. Alla fine di ogni proprio turno effettua un TS Costituzione: tre successi pongono fine all'incantesimo, tre fallimenti la trasformano in pietra a tempo indeterminato (condizione pietrificato). I successi e i fallimenti non devono essere consecutivi: si conteggiano fino al raggiungimento di tre dello stesso tipo. Mentre lo strato è attivo, non è possibile lanciare incantesimi attraverso il muro. Distrutto dalla luce intensa generata da luce diurna o da un incantesimo equivalente di livello pari o superiore.\n\n7. Viola. TS fallito: la creatura è accecata. All'inizio del turno successivo dell'incantatore deve effettuare un TS Saggezza: con successo non è più accecata; con fallimento viene trasportata su un altro piano d'esistenza scelto dal DM (in genere, una creatura su un piano diverso da quello d'origine viene esiliata sul piano d'origine; le altre vengono inviate sul Piano Astrale o sul Piano Etereo) e non è più accecata. Distrutto da dissolvi magie o da un incantesimo simile di livello pari o superiore in grado di porre fine a effetti magici.",
    higherLevels: null
  },
  "Shapechange": {
    name: "Trasformazione",
    description: "L'incantatore assume la forma di una creatura diversa per la durata. La nuova forma può essere qualsiasi creatura con grado di sfida pari o inferiore al livello dell'incantatore, purché non sia un costrutto né un non morto e l'incantatore l'abbia vista almeno una volta. L'incantatore diventa un esemplare comune di quella creatura, privo di livelli di classe e del tratto Incantesimi.\n\nLe statistiche di gioco vengono sostituite da quelle della creatura scelta, ma l'incantatore conserva il proprio allineamento e i punteggi di Intelligenza, Saggezza e Carisma. Mantiene anche le proprie competenze in abilità e tiri salvezza, e ne acquisisce in più quelle della creatura: se per la stessa competenza il bonus della creatura supera il proprio, usa quello della creatura. Non può usare azioni leggendarie né azioni di tana della nuova forma.\n\nL'incantatore acquisisce i punti ferita e i Dadi Vita della nuova forma. Tornando alla forma originale, recupera il numero di PF che possedeva prima della trasformazione. Se torna alla forma originale per essere sceso a 0 PF, gli eventuali danni in eccesso si applicano alla forma originale; finché questi non la portano a 0 PF, l'incantatore non cade privo di sensi.\n\nL'incantatore conserva i privilegi forniti da classe, razza o altre fonti, e può sfruttarli purché la nuova forma glielo consenta fisicamente. Non dispone dei sensi speciali (per esempio scurovisione) a meno che anche la nuova forma li possieda, e può parlare solo se la creatura è normalmente in grado di farlo.\n\nAl momento della trasformazione, l'incantatore sceglie come gestire l'equipaggiamento: lasciarlo cadere, fonderlo nella nuova forma o indossarlo. L'equipaggiamento indossato funziona normalmente, ma sta al DM stabilire cosa sia praticamente indossabile dalla nuova forma in base a forma e taglia. Gli oggetti non si adattano alle dimensioni della nuova forma: ciò che la nuova forma non può indossare deve cadere o fondersi. L'equipaggiamento fuso non produce alcun effetto in quello stato.\n\nPer la durata, l'incantatore può usare la propria azione per assumere una forma diversa, seguendo le stesse regole e restrizioni della prima trasformazione, con un'eccezione: se la nuova forma possiede più PF dei suoi PF attuali, i suoi PF restano comunque al valore attuale.",
    higherLevels: null,
  ...
  "True Polymorph": {
    ...
    description: "L'incantatore sceglie una creatura o un oggetto non magico entro gittata che riesce a vedere e attua una trasformazione: una creatura può diventare un'altra creatura o un oggetto non magico, oppure un oggetto può diventare una creatura (purché non indossato o trasportato). La trasformazione dura per la durata, oppure finché il bersaglio scende a 0 PF o muore. Se l'incantatore mantiene la concentrazione per l'intera durata, la trasformazione diventa permanente.\n\nL'incantesimo non funziona su mutaforma o su creature già a 0 PF. Un bersaglio non consenziente può tentare un TS Saggezza per resistere; con un successo è immune all'effetto.\n\nDa Creatura a Creatura. La nuova forma può essere di qualsiasi tipo a scelta dell'incantatore, purché il suo grado di sfida (o livello, se non ha GS) sia pari o inferiore a quello del bersaglio originale. Le statistiche di gioco — incluse le caratteristiche mentali — sono sostituite da quelle della nuova forma; restano invariati allineamento e personalità. Il bersaglio acquisisce i PF della nuova forma e, al ritorno alla forma originale, recupera quelli che aveva prima del lancio. Se torna alla forma originale per essere sceso a 0 PF, gli eventuali danni in eccesso si applicano alla forma originale; finché questi non la portano a 0 PF, non cade priva di sensi. Le azioni sono limitate a quelle compatibili con la nuova forma: niente parlare, lanciare incantesimi o compiere azioni che richiedano parola o mani, salvo che la nuova forma sia in grado di farlo. L'equipaggiamento si fonde nella nuova forma e non può essere attivato, impugnato o sfruttato.\n\nDa Oggetto a Creatura. La creatura ottenuta non può superare la taglia dell'oggetto e ha GS al massimo 9. È amichevole nei confronti dell'incantatore e dei suoi compagni e agisce nei suoi turni, eseguendo le azioni e i movimenti decisi dall'incantatore (statistiche e risoluzione spettano al DM). Se la trasformazione diventa permanente, l'incantatore perde il controllo: la creatura potrà rimanere amica o no, in base a come è stata trattata.\n\nDa Creatura a Oggetto. Tutto ciò che la creatura indossa o trasporta si fonde nell'oggetto, purché la taglia dell'oggetto non sia inferiore a quella della creatura. Le statistiche diventano quelle dell'oggetto; al termine dell'incantesimo, quando torna alla forma originale, la creatura non ricorderà nulla del tempo trascorso come oggetto.",
    higherLevels: null,
